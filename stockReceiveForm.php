...
if(isset($_POST['receive'])){
  ...
  $supplydate = $_POST['supplydate1'];
  $addqry="UPDATE items_objects SET balance = balance + '$received' WHERE item='$category'";
  $qry ="INSERT INTO received VALUES('','$orderno','$timing','$category','$scheme','$received','$amount','$unit','$gst".'%'."','$taxableValue','$bill','$description','$supplydate','$inventory')";
    ...
    <div class="entmainndi">
      ...
      <div id="entformarea">
        <div class="form-group entform-group">
          ...
          <input type="text" name="orderno1" id="orderno" class="form-control"  placeholder="Enter Purchase order No"  >
        </div>
        <div class="form-group entform-group">
          <label for="timing">Purchase date</label>
        ...
        <div class="form-group entform-group">
          ...
          <input type="date" pattern="" class="form-control" id="supplydate" placeholder="Enter email" value="<?php echo date('Y-m-d'); ?>" name="supplydate1">
        </div>
        ...
        <div class="form-group entselect">
          ...
          <select onload="splitVendor(this.options[this.selectedIndex].text)" onchange="splitVendor(this.options[this.selectedIndex].text)" class="custom-select" style="border:1px solid #ced4da !important;" selected name="vendor" id="vendor" placeholder="sdfsdf">
        <?php
        $getVendor= "SELECT * FROM Supplier";
        ...
        <div class="form-group entform-group">
          ...
          <input type="text" class="form-control" id="received" placeholder="Enter Purchased" name="received1">
        </div>
        <div class="form-group entform-group">
          <label for="amount">Amount(including G.S.T)</label>
        ...
        <div class="form-group entform-group">
          <label for="netValue">Amount(without G.S.T)</label>
