...
if(isset($_POST['issue'])){
    ...
    $issueQry = "INSERT into issued VALUES('','$timingIssue','$descriptionIssue','$category','$name','$idNo','$issued','$unit','$dept','$scheme','$inventory')";
    ...
    if(!$issueQryExe){
      echo '<script>alert("Entry is not done try again")</script>';
        ...
        if(mail("nikunjkr078@gmail.com", "New Item Issued", "This is to inform you that $issued $category have been issued to $name having Id No:- $idNo . \n\n\n With Regards \n Computer Centre\n IIIT Bhagalpur"))
      ...
      <div id="entformarea">
       ...
       <div class="form-group entform-group">
        ...
        <div class="form-group entform-group">
          ...
          <input type="text" class="form-control" id="issued" placeholder="Enter Quantity" name="issued" onkeyup="compare(this)">
        </div>
